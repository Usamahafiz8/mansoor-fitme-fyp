...
export default function Carousel({slides}) {
    ...
    <div className="relative">
      <ul className="flex overflow-x-auto scrollbar-hide snap">
        {slides.map((slide, idx) => (
          <li
            ...
            className="relative w-full h-[80vh] snap-center">
            <img src={slide.image} className="w-full h-full  object-top" />
            <div
              className={clsx(
      ...
      <span className="absolute rounded-full bg-gray-800/40 flex justify-center items-center bottom-6 left-6 z-10 cursor-pointer text-white p-2"></span>
    </div>
  );
}